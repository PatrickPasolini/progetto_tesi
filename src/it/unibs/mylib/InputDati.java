...
public final static char RISPOSTA_SI = 'Y';
	...
	public static double leggiDoubleConMinMax(String messaggio, double minimo, double massimo) {
		boolean finito = false;
		double valoreLetto = 0;
		do {
			valoreLetto = leggiDouble(messaggio);
			if (valoreLetto >= minimo && valoreLetto <= massimo)
				...
				System.out.println("Attenzione: e' richiesto un valore compreso tra " + minimo + " e " + massimo);
		} while (!finito);
